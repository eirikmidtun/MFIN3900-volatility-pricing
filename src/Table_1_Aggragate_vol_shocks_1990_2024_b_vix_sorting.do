/*******************************************************************************
* TABLE 1 Aggregate Volatility Shocks
* Filter param: b_d_vix
* Perdiod:jan 1990 - des 2024
*******************************************************************************/
clear all
set more off
...
/**************************************************************
* Monthly returns with market cap (for beta formation)
**************************************************************/
use CRSP_monthly_1926_2024.dta, clear
...
/**************************************************************
* Daily returns with market cap (for beta formation)
**************************************************************/
...
/**************************************************************
Value Weighted Portfolio Returns monthly
**************************************************************/
use `ivol_measure'_return_monthly.dta, clear
...
estout using table_1_`ivol_measure'_Ang_Table_IV_alphas.txt, cells(b(fmt(4) star) t(fmt(2))) /*
...
by ivol_quintile month_id: asreg ret vwretd smb hml delta_vix, fit save(betas)

rename _b_vwretd b_mkt
rename _b_delta_vix b_d_vix

label var b_mkt "Monthly calculated from: asreg ret vwretd delta_vxo"
label var b_d_vix "Post formation b_d_vix Monthly delta vxo calculated from: asreg ret vwretd delta_vxo"

keep b_mkt b_d_vix month_id ivol_quintile
duplicates drop 
keep if b_d_vix != .
duplicates list month_id ivol_quintile
collapse (mean) b_d_vix, by(ivol_quintile)
rename b_d_vix b_d_vix_avg_beta_post_formation
save b_d_vix_avg_beta_post_formation.dta, replace

/**************************************************************
* Control parameters

* parameters: bm, size, mkt_share
**************************************************************/
* book to market
...
outsheet using table_1_`ivol_measure'_Ang_Table_IV.txt, replace
