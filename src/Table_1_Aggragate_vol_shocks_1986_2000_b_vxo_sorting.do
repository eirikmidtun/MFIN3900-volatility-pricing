/*******************************************************************************
* Replication TABLE 1 Ang et al. (2006)
...
merge 1:1 permno month_id using DATA_b_fvix_monthly_stocks_1986-2000.dta
keep if _merge==3 
drop _merge
...
/*************************************************************/
* post formation b_vix
use `ivol_measure'_value_weighted_returns_daily.dta,clear
...
label var _b_delta_vxo "Post formation b_d_vxo Monthly delta vxo calculated from: asreg ret vwretd delta_vxo"

keep b_mkt _b_delta_vxo month_id ivol_quintile
duplicates drop 
keep if _b_delta_vxo != .

collapse (mean) _b_delta_vxo, by(ivol_quintile)

rename _b_delta_vxo b_d_vxo_avg_beta_post_formation
save b_d_vxo_avg_beta_post_formation.dta, replace
