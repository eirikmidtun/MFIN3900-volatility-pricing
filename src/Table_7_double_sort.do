/*******************************************************************************
* Replication of table 7 Ang et al. (2006)
...
local sample_start = mofd(mdy(7,1,1963))
...
merge 1:1 permno month_id using DATA_monthly_bid_ask_1926_2024.dta
*merge 1:1 permno month_id using vol_monthly_1926_2024.dta
*merge 1:1 permno month_id using COMPUSTAT_BM_lev_turnover_1970-01-31_2024-12-31.dta
*merge 1:1 permno month_id using DATA_return_size_data_1926_2024.dta
keep if _merge==3 
drop _merge
...
estout using table_7_Ang_Table_VI_1963-2025_`control_filter'_alphas.txt, cells(b(fmt(4) star) t(fmt(2))) /*
...
outsheet using table_7_Ang_Table_VI_1963-2025_`control_filter'.txt, replace
