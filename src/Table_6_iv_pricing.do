/*******************************************************************************
Replication Table VI Ang et al. (2006)
*******************************************************************************/
clear all
set more off
...
estout using table_6_`ivol_measure'_Ang_Table_VI_alphas.txt, cells(b(fmt(4) star) t(fmt(2))) /*
...
outsheet using table_6_`ivol_measure'_Ang_Table_VI.txt, replace
